...
<header>
    ...
    <?php }
        if ($anio==2019) {  ?> 
        <h4 class="nombre-anio" style="margin-left: -22px;">“Año de la lucha contra la corrupción e impunidad”</h4>
    <?php } ?>
...
<header>
    ...
    <?php }
          if ($anio==2019) {  ?>
          <?php if($tamano == 5): ?>
              <h4 class="nombre-anio" style="margin-left: -35px;">“Año de la lucha contra la corrupción e impunidad”</h4>
          <?php else: ?>
