...
@section('includes')
    ...
    @include( 'admin.mantenimiento.js.personafinal_ajax' )
    @include( 'admin.mantenimiento.js.personafinal' )
@stop
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="t_persona" class="table table-bordered table-hover">
                                        <thead>
                                        <tr>
                                        <th colspan="12" style="text-align:center;background-color:#A7C0DC;"><h2>Persona</h2></th>
                                        </tr>
                                        <tr></tr>
                                        </thead>
                                        <tbody>
...
@section('formulario')
     @include( 'admin.mantenimiento.form.personafinal' ) 
@stop
