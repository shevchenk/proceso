    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="form_personas_modal" name="form_personas_modal" action="" method="post">
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-12">
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" placeholder="Ingrese Nombre" disabled name="txt_nombre" id="txt_nombre">
                </div>
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" placeholder="Ingrese Apellido Paterno" disabled name="txt_paterno" id="txt_paterno">
                </div>
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" placeholder="Ingrese Apellido Materno" disabled name="txt_materno" id="txt_materno">
                </div>
              </div>
              ...
              <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" placeholder="Ingrese DNI" disabled name="txt_dni" id="txt_dni">
                </div>
                <div class="col-sm-4">
          ...
          <fieldset id="f_areas_cargo" style="display:none;">
