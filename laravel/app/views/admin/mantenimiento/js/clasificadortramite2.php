...
GeneraFn=function(row,fn){ // No olvidar q es obligatorio cuando queire funcion fn
    ...
    if(typeof(fn)!='undefined' && fn.col==5 && row.estado_final == 0){
        var grupo='';
    ...
    if(typeof(fn)!='undefined' && fn.col==6  && row.ruta_flujo_id!==null && row.estado_final == 0){
        var grupo='';
    ...
    if(typeof(fn)!='undefined' && fn.col==8 && row.estado_final == 0){
