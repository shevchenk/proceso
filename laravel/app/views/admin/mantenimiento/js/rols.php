...
$(document).ready(function() {
    ...
    */
    ...
    slctGlobalHtml('slct_estado, #slct_nivel','simple');
    var idG={   nombre        :'onBlur|Nombre Rol|#DCE6F1', //#DCE6F1
                nivel         :'1|Nivel|#DCE6F1', //#DCE6F1
    ...
    $('#rolModal').on('show.bs.modal', function (event) {
      ...
      $("#form_rols_modal input[type='hidden']").remove();
        ...
        if(titulo=='Nuevo'){
            ...
            $('#form_rols_modal #slct_nivel').val(1);
            ...
            $('#form_rols_modal #slct_nivel').val( RolsG.nivel );
...
BtnEditar=function(btn,id){
    ...
    RolsG.nivel=$(tr).find("td:eq(1)").text();
