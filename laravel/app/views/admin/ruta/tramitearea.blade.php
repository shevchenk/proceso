...
@section('includes')
    ...
    @include( 'admin.ruta.js.tramitearea_ajax' )
    @include( 'admin.ruta.js.tramitearea' )
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body col-md-12">
                          <div class="col-md-12" style="padding-top: 10px">
                              ...
                              <div class="col-md-3">
                                  <input class="form-control" type="text" id="txt_numareas" name="txt_numareas" placeholder='Número Áreas' onkeyup="cargarTabla()" maxlength="2" onkeypress="return validaNumeros(event);">
                                  <!--<div class="radio">
