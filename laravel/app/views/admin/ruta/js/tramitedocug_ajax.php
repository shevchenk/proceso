        ...
        $.ajax({
            ...
            success : function(obj) {
                ...
                if(obj.rst==1){
                    ...
                    $("#tb_usuarios, #tb_referidos").html('');
                    $('#cbo_tiposolicitante,#cbo_tipotramite,#cbo_tipodoc,#cbo_persona,#cbo_empresa,#cbo_tipodocumento, #slct_areas, #slct_local').multiselect('refresh');
