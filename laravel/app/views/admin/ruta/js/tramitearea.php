...
cargarTabla = function(){
    ...
    if(cantidad>0 && cantidad<40){
        ...
        for(var i=0 ; i<cantidad ; i++){
            html= "<tr>";
            html+= "    <td>";
            html+= "        <select class='form-control select_area' onChange='CargarLocalArea(this,"+i+")' id='select_area"+i+"' name='slct_area[]'></select>";
            html+="     </td>";
            html+= "    <td>";
            html+= "        <select class='form-control select_local_destino' id='select_local_destino"+i+"' name='slct_local_destino["+i+"][]' multiple></select>";
            html+="     </td>";
            html+= "</tr>";
