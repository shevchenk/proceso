...
class Area extends Base
{
    ...
    {
        $sSql=" SELECT a.id, a.nombre,a.nemonico,a.imagen,a.imagenc,a.imagenp, a.estado, a.locales_id,
                (SELECT GROUP_CONCAT(local) FROM locales l2 WHERE FIND_IN_SET(l2.id,a.locales_id) > 0 ) locales
                FROM areas a
                WHERE 1=1 ";
        $sSql.= $array['where'].
                $array['order'].
