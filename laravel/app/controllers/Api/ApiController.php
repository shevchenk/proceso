    ...
    public function IniciarProceso($r)
    {
        ...
        $empresa = array(
            ...
            'campos' => array(
                ...
                $campos[20] => $r['nro_ins'],
                $campos[21] => $r['tipo_ins'],
                $campos[22] => $r['monto_ins'],

                $campos[23] => $r['nro_mat'],
                $campos[24] => $r['tipo_mat'],
                $campos[25] => $r['monto_mat'],

                $campos[26] => $r['nro_cur'],
                $campos[27] => $r['tipo_cur'],
                $campos[28] => $r['monto_cur'],
                $campos[29] => $r['total_cur'],

                $campos[30] => $r['nro_pro'],
                $campos[31] => $r['tipo_pro'],
                $campos[32] => $r['monto_pro'],

                $campos[33] => $r['cajero'],
                $campos[34] => $r['vendedor'],
                $campos[35] => $r['responsable'],
                $campos[36] => $r['created_at'],
